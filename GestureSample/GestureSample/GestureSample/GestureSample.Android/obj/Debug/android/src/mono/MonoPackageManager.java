...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "GestureSample.Android.dll" comes first in this list. */
		"GestureSample.Android.dll",
		"FormsViewGroup.dll",
		"GestureSample.dll",
		...
		"XamarinFormsGesture.dll",
		"XamarinFormsGesture.Droid.dll",
	};
